...
- **Nueva escena `AndanaScene`** — historia de la familia Andana, organizadora histórica de la Cucaña. Se lanza al pulsar el barquito durante la cinemática de entrega de la bandera. Al terminar (o pulsar SALTAR) arranca la partida directamente. Contenido en `src/game/config/andanaContent.js` (2 bloques con imágenes `andana-01` y `andana-02` — WebP convertidas de PNG 1096×1096 y 1448×1086). Nuevo narrador `narrator-andana` (spritesheet 140×35, 4 frames).
