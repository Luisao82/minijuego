...
export const PHASE1 = {
  ...
  PERFECT_IMPULSE_MIN: 0.97, // Umbral mínimo para considerar el impulso "perfecto" (oportunidad de trozo de mapa). 0.97 = últimos 3% de la barra → ventana ~12 px sobre los 400 px totales.
