// Contenido narrativo de AndanaScene — historia de la familia Andana,
// organizadora histórica de la Cucaña de Triana.
// Cada bloque tiene un título, una imagen (key de asset) y varias páginas
// de texto. Para editar el guion, añadir bloques o cambiar imágenes,
// edita solo este archivo.

export const ANDANA_BLOCKS = [
  {
    title: 'Historia',
    image: 'andana-01',
...
// Texto que aparece al completar todos los bloques, antes del botón final.
export const ANDANA_END_TEXT = '¡Larga vida a la familia Andana y a la Cucaña de Triana!'
