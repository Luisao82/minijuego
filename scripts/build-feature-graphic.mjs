...
const TRIANERO_PATH = resolve(
  PROJECT_ROOT,
  'public/assets/sprites/characters/spritesheet/feriante.png'
)
const FLAMENCA_PATH = resolve(
  PROJECT_ROOT,
  'public/assets/sprites/characters/spritesheet/flamenca.png'
)
